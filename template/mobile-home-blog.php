				     		...
				     		<div class="pull-right">
				     			<div class="share">
					     			<ul class="nav nav-pills"> 
										...
										<li role="presentation" style="border-right: solid 1px #b1b0b1;"><a target="_blank" href="https://twitter.com/intent/tweet?text=<?php echo get_the_title($post->ID); ?>&url=<?php echo get_permalink($post->ID); ?>"><i class="fa fa-twitter"></i></a></li>
									</ul>
				     			</div>
				     		</div>
						</div>
